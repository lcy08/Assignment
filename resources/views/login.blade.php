    ...
    <div class="w-full flex lg:flex-row flex-col">
        <div class="flex lg:flex-3/5">
            <div class="flex-col flex w-full justify-center items-center h-screen">
                ...
                @if(session('error'))
                    <div class="w-1/2 bg-red-500 text-white p-2 rounded-lg text-center">
                        {{ session('error') }}
                    </div>
                @endif
        ...
        <img src="{{ asset('images/Frame 98699.png') }}" alt="sideart" class="w-full flex lg:flex-2/5 lg:h-screen">
    </div>

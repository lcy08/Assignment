        ...
        <main class="main-content w-full bg-gray-100 md:mt-2 pb-24 md:pb-5 p-4">
            ...
            <form action="{{ route('add') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input onchange="preview()" type="file" name="image" id="image" accept="image/png image/jpeg" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
